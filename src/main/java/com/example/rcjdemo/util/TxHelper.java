...
//    public Peer.CertId superCertId;
    ...
    /**
     * 无参构造函数默认为super_admin
     */
    public TxHelper() throws IOException, OperatorCreationException, PKCSException {
        this("identity-net:951002007l78123233", "super_admin", "951002007l78123233.super_admin2.0.pem");
    }
...
//    }
    ...
    public Peer.Transaction callArgTx(String scName, Integer scVer, String funcName, String argString) {
